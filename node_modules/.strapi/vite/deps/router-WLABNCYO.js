...
var ProtectedListPage = (0, import_react.lazy)(() => import("./settings-BMURPKOW.js").then((mod) => ({
  default: mod.ProtectedListPage
})));
var ProtectedEditPage = (0, import_react.lazy)(() => import("./id-F5XTIJKL.js").then((mod) => ({
...
//# sourceMappingURL=router-WLABNCYO.js.map
